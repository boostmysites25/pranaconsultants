          ...
          <div className="relative z-10 px-6 justify-center h-full flex flex-col items-center gap-5 text-center md:max-w-[60rem] mx-auto">
            ...
            {isWebDevelopment ? (
              <h1 className="heading-1 text-white leading-tight">
                Engineering Intelligent Web Ecosystems to Solidify Your
                <span className="text-primary"> AI </span>
                Driven Digital Authority
              </h1>
            ) : (
              <h1 className="heading-1 text-white leading-tight">
                Leveraging <span className="text-primary"> Artificial Intelligence </span> to
          ...
          >
            <div className="flex flex-col gap-7">
              <h2 className="heading-2">
                {isWebDevelopment
                  ? "Elevating Digital Identity through Advanced Web Architectures"
                  : "Developing Mobile Solutions that Drive Strategic Advantage"}
              </h2>
              <p className="desc">
                {isWebDevelopment
                  ? "We merge aesthetic precision with technical rigor to build web platforms that not only represent your brand but serve as powerful engines for growth. Our responsive, scalable architectures ensure you stay ahead of the curve."
                  : "From visionary startups to global enterprises, we deliver end-to-end mobile engineering that transforms concepts into market-leading applications. We focus on engagement, performance, and scalability to give you a definitive competitive edge."}
              </p>
            </div>
