      ...
      <div ref={wrapperRef} className="wrapper">
        <div className="py-[5rem] grid md:grid-cols-[30%_65%] grid-cols-1 gap-10">
          <div className="w-full flex flex-col gap-10">
            ...
            >
              <h4 className="text-2xl font-medium">Our Expertise</h4>
            ...
            <Link to={`tel:${companyDetails.phone}`} className="font-semibold">
              ...
              >
                ...
                <h4 className="text-2xl font-medium">Immediate Support</h4>
                <Link
          ...
          >
            ...
            <div className="flex flex-col gap-3 w-full">
              ...
              <Link
                ...
                className="purple-btn flex justify-center items-center gap-2 rounded-md"
              >
                Schedule Consultation <IoIosArrowRoundForward className="text-3xl" />
              </Link>
            </div>
          </div>
          <Link to={`tel:${companyDetails.phone}`} className="font-semibold">
            ...
            >
              ...
              <h4 className="text-xl font-semibold">Immediate Support</h4>
              <h4
                // to={`tel:${companyDetails.phone}`}
                className="font-semibold"
              >
